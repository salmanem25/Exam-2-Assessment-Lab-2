```markdown
# Econ 396 Exam-Lab Assessment 2 – Agricultural Data Analysis
...
├── Exam2_Solution.Rmd             # R Markdown script (the solution)
...
2. Place `Exam 2 Input File.csv` and `Exam2_Solution.Rmd` in the same directory.
3. Open `Exam2_Solution.Rmd` in RStudio.
...
| File | Description |
|------|-------------|
| `Exam2_Solution.html` | Knitted report containing all code, outputs, and plots. |
...
- **Author**: Student, Econ 396 – Spring 2026
